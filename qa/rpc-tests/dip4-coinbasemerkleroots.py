#!/usr/bin/env python3
# Copyright (c) 2015-2018 The Xebec Core developers
...
class LLMQCoinbaseCommitmentsTest(XebecTestFramework):
    def __init__(self):
    ...
    def run_test(self):
        ...
        # Register one more MN, but don't start it (that would fail as XebecTestFramework doesn't support this atm)
