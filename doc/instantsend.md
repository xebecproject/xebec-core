...
This mechanism has been integrated into Bitcore-Node-Xebec which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/xebecproject/insight-api-xebec#web-socket-api](https://github.com/xebecproject/insight-api-xebec#web-socket-api)
* API: [https://github.com/xebecproject/insight-api-xebec#instantsend-transactions](https://github.com/xebecproject/insight-api-xebec#instantsend-transactions)
