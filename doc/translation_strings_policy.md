...
This document provides guidelines for internationalization of the Xebec Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `xebec_en.ts` remains unchanged.
