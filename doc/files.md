...
* xebec.conf: contains configuration settings for xebecd or xebec-qt
* xebecd.pid: stores the process id of xebecd while running
* database/*: BDB database environment; only used for wallet
* db.log: wallet database log file
* debug.log: contains debug information and general logging generated by xebecd or xebec-qt
