# Linearize
Construct a linear, no-fork, best version of the Xebec blockchain. The scripts
run using Python 3 but are compatible with Python 2.

## Step 0: Install xebec_hash

https://github.com/xebecproject/xebec_hash
...
JSON-RPC server. Running `xebecd` or `xebec-qt -server` will be sufficient.
...
* `input`: xebecd blocks/ directory containing blkNNNNN.dat
