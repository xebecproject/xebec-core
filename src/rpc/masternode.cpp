...
void masternode_list_help()
{
    throw std::runtime_error(
            ...
            "  owneraddress   - Print the masternode owner Xebec address\n"
            "  payee          - Print the masternode payout Xebec address (can be additionally filtered,\n"
            "                   partial match)\n"
            "  pubKeyOperator - Print the masternode operator public key\n"
            "  status         - Print masternode status: ENABLED / POSE_BANNED\n"
            "                   (can be additionally filtered, partial match)\n"
            "  votingaddress  - Print the masternode voting Xebec address\n"
        );
}
...
{ //  category              name                      actor (function)         okSafe argNames
  //  --------------------- ------------------------  -----------------------  ------ ----------
    { "xebec",               "masternode",             &masternode,             true,  {} },
    { "xebec",               "masternodelist",         &masternodelist,         true,  {} },
    { "xebec",               "getpoolinfo",            &getpoolinfo,            true,  {} },
#ifdef ENABLE_WALLET
    { "xebec",               "privatesend",            &privatesend,            false, {} },
#endif // ENABLE_WALLET
};
