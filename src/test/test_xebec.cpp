...
#define BOOST_TEST_MODULE Xebec Test Suite

#include "test_xebec.h"
...
TestingSetup::TestingSetup(const std::string& chainName) : BasicTestingSetup(chainName)
{
    const CChainParams& chainparams = Params();
        ...
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_xebec_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));
